...
test.describe('App', () => {
  ...
  test.describe('a faction tower', () => {
    ...
    const towerSave = {
      ...
      rates: { gold: '4', xp: '2', essence: '1', summons: '0.5', emblem: '0' },
      lastTickAt: Date.now(),
      ...
      roster: [
        ...
        { defId: 'halric', rarity: 0, level: 1, copies: 0, gear: {}, signature: 0 },
        { defId: 'ysolde', rarity: 0, level: 1, copies: 0, gear: {}, signature: 0 },
