...
skeleton without changing its shape. See [`docs/milestones.md`](docs/milestones.md) for the
full detail and design rationale for each.
...
docs/     Project documentation, e.g. docs/milestones.md.
