...
- **Faction towers are a second thing to climb**, and **all seven ship** — the system in milestone
  ...
  - ⚠️ **Two of the seven are still a hundred floors short, and that is milestone 21e–21k in
  ...
  - **Every faction carries at least six archetypes and all three tiers**, which is what 15c's
    ...
    A hundred and twenty-two ship, and the distribution is deliberately uneven: milestone 18 took Angels to
    ...
    that is the other half of the "fix the leans up front" discipline and it applies through 21i–21k.
    - ⚠️ **A tower with no lean spreads its four blocks the way it spreads its boards, and 21i is the
      ...
      thinnest is not decoration there: 21j takes Demons to 16 and 21k Angels to 15, and **neither
  ...
  - ⚠️ **How a second hundred escalates is a per-tower answer and five towers have given five
  ...
  - **Nothing in the crystal economy is linear in the stage index.** A first clear pays a flat 250
    ...
    - ⚠️ **Only the ceiling on that ratio is stable; the floor falls as content ships, by
      ...
      **0.74** — the last two landing on the figures 21b projected for them, to two decimal places.
      ...
      Monster Tower to **1.255**. The step has been +0.105 **five** times running, to three decimal
      places; expect the same through 21j–21k.
    - ⚠️ **The floor is 0.7 right now and that is a mid-milestone placeholder, not a decision.**
      ...
      now landed and the campaign side is at 297,500 against the towers' 373,500** — 219,100 at the
      end of 21d, which is the figure 21b projected for it, plus the Human, Dwarf, Elf, Undead and
      Monster Towers' second hundreds. The cost is that it watches nothing until 21k. That is the same call 21a made on the level ceiling's ratio
