...
- **Faction towers are a second thing to climb**, and **all seven ship** — the system in milestone
  ...
  - ⚠️ **One of the seven is still a hundred floors short, and that is milestone 21k in
  ...
  - **Every faction carries at least six archetypes and all three tiers**, which is what 15c's
    ...
    A hundred and twenty-six ship, and the distribution is deliberately uneven: milestone 18 took Angels to
    ...
    that is the other half of the "fix the leans up front" discipline and it applies through 21k;
    21i took the four thinnest a block each, 21j took Demons 13 → **seventeen**. ⚠️ **A count quoted
    in the roadmap ahead of time goes stale the moment a session spends a block outside its own
    lean** — 21i's spread block took Demons to 13, so 21j's four landed on 17 against a roadmap that
    said 16, and 21k lands on 16 against a roadmap that said 15. The rule did not move; the count it
    was quoted against did. **Recompute the depth table rather than reading it.**
    - ⚠️ **A tower with no lean spreads its four blocks the way it spreads its boards, and 21i is the
      ...
      thinnest is not decoration there: 21j takes Demons to 17 and 21k Angels to 16, and **neither
      touches Humans**, so without that session Human would have closed milestone 21 as the standout
  ...
  - ⚠️ **How a second hundred escalates is a per-tower answer and six towers have given six
  ...
  - **Nothing in the crystal economy is linear in the stage index.** A first clear pays a flat 250
    ...
    - ⚠️ **Only the ceiling on that ratio is stable; the floor falls as content ships, by
      ...
      **0.74** — the last two landing on the figures 21b projected for them, to two decimal places.
      ...
      Monster Tower to **1.255** and 21j's Angel Tower to **1.361**. ⚠️ **The step is exactly 31,300
      crystals — one tower's second hundred — so it is exactly +0.1052 every time by construction**,
      which is why it has read the same six times running. Do not verify it by subtracting the
      rounded ratios; 1.255 → 1.361 looks like +0.106. Expect the same at 21k.
    - ⚠️ **The floor is 0.7 right now and that is a mid-milestone placeholder, not a decision.**
      ...
      now landed and the campaign side is at 297,500 against the towers' 404,800** — 219,100 at the
      end of 21d, which is the figure 21b projected for it, plus the Human, Dwarf, Elf, Undead and
      Monster and Angel Towers' second hundreds. The cost is that it watches nothing until 21k. That is the same call 21a made on the level ceiling's ratio
