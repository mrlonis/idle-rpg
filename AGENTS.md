...
- **Faction towers are a second thing to climb**, and **all seven ship** — the system in milestone
  ...
  - ⚠️ **Three of the seven are still a hundred floors short, and that is milestone 21e–21k in
  ...
  - **Every faction carries at least six archetypes and all three tiers**, which is what 15c's
    ...
    A hundred and eighteen ship, and the distribution is deliberately uneven: milestone 18 took Angels to
  ...
  - ⚠️ **How a second hundred escalates is a per-tower answer and four towers have given four
  ...
  - **Nothing in the crystal economy is linear in the stage index.** A first clear pays a flat 250
    ...
    - ⚠️ **Only the ceiling on that ratio is stable; the floor falls as content ships, by
      ...
      **0.74** — the last two landing on the figures 21b projected for them, to two decimal places.
      ...
      over parity with the campaign since chapter 8 — and 21h's Undead Tower to **1.150**. The step
      has been +0.105 four times running, to three decimal places; expect the same through 21i–21k.
    - ⚠️ **The floor is 0.7 right now and that is a mid-milestone placeholder, not a decision.**
      ...
      now landed and the campaign side is at 297,500 against the towers' 342,200** — 219,100 at the
      end of 21d, which is the figure 21b projected for it, plus the Human, Dwarf, Elf and Undead
      Towers' second hundreds. The cost is that it watches nothing until 21k. That is the same call 21a made on the level ceiling's ratio
