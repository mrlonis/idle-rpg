...
- **[docs/towers.md](docs/towers.md)** — seven faction towers, **four hundred floors each and only the
  Human, Dwarf and Elf Towers there yet**. What a tower is for, the three fields a clear may never touch, the
...
- ⚠️ **A tower's height is one rule for all seven, so a bump strands six of them.** A tower that has
  ...
  notices a tower nobody went back for. **The list is live right now with four names on it** — the Human,
  Dwarf and Elf fourth hundreds have landed. [towers](docs/towers.md)
