 ...
 * authored), again for the third, and it is happening again for the fourth — **the Human Tower is the
 * only one at four hundred floors today.** A tower that has not been extended simply ends at its last
 ...
 * for the third time with **six** names on it. **Do it the same way every time the height moves.**
 *
