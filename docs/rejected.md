...
for the four chapters that ship, 500 for the first band, 9,500 to reach chapter 100. The first band
...
the sweep rejected was a single sampled stage authored too light — `c4-s31`, a band opener that a
