...
3. **The lineup bonus** — _planned, milestone 8b, not built._ A bonus for how many of one faction
...
| Term                 | Means                                                                                                                                                                                                                                                                                                                                                               |
| -------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **ATB**              | The turn system. `gauge += haste` each tick, plus `attackSpeed` on the ticks the next action would be a basic attack; act at `ATB_THRESHOLD` (1000). Haste buys _turns_, not just going first.                                                                                                                                                                      |
