...
| **Emblem**           | What a signature level costs, and the only thing it buys. One universal currency rather than one per faction, because the roster ships **one ascended-tier character per faction** — seven emblems would give each a private pool nothing else could spend, and no two heroes would ever compete.                                                                                                                   |
